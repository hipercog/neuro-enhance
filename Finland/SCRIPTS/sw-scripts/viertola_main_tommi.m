...
for s=49:size(subjects,2)
    
    bvfile = ['Kh' subjects{s} '_Swi.vhdr'];
    logfile = ['Kh' subjects{s} '-Switching_task.log'];
    eventpath = [savepath '\' subjects{s} '-swi-recoded.evt'];
    savename = [subjects{s} '-swi-recoded.set'];
    ...
    if allclear == 1
        ...
        eventpath_notOK = [savepath '\' subjects{s} '-swi-recoded_missingTriggers.evt'];
